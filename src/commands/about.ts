...
SEE ALSO
  ...
  execute: (_args, _ctx): OutputLine[] => [
    ...
    { text: "" },
    {
      text: "  Full Stack JS/TS developer with ~16 months commercial",
      className: "welcome-info",
    },
    {
      text: "  experience. Built the R.Toys e-commerce platform at",
      className: "welcome-info",
    },
    {
      text: "  Pinta Webware — Next.js, tRPC, Prisma, PostgreSQL,",
      className: "welcome-info",
    },
    {
      text: "  and React Native in a monorepo architecture.",
      className: "welcome-info",
    },
    { text: "" },
    ...
    { text: "    · Network tooling  · Home servers" },
    { text: "" },
